<nav class="bg-white dark:bg-gray-900 shadow-sm dark:border-b dark:border-gray-900">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:ml-6 sm:flex sm:items-center sm:space-x-3">
                <x-cockpit::badge red>{{ config('app.env') }}</x-cockpit::badge>
                <x-cockpit::nav.link href="https://github.com/devsquad/cockpit" no-border>GitHub</x-cockpit::nav.link>
            </div>
