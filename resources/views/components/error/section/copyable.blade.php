...
<div x-data="copyable('{{ $id }}', '{{ $codeType }}')" class="relative rounded-md text-dark-primary bg-gray-300 dark:bg-dark-even dark:text-white p-4 w-full">
    <button type="button" x-on:click="copy()" class="absolute right-0 top-0 p-2 text-dark-primary hover:text-gray-400 dark:text-white dark:hover:text-primary"
